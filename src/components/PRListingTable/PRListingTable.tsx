...
const PRListingTable = ({ repo }: Props) => {
    ...
    return (
        <div className="md:w-[100%] md:mx-auto">
            {isLoading && <p role="status" className='text-xl font-bold w-72 h-72 pt-32 mx-auto text-center rounded-lg'>Loading.....</p>}
            {!isLoading && !prList && <p role="alert" className="text-xs font-bold w-72 h-72 pt-32 mx-auto text-center rounded-lg md:text-base text-red-600">Repository Not Found, Please enter a valid repository.</p>}
                                ...
                                <td>
                                    <div>
                                        <div className="flex px-2 py-1">
                                            <span className="pr-2 pt-1" aria-hidden="true">
                                                <svg role="img"
                                                    style={{ fill: "green" }}
                                                    viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path d="M1.5 3.25a2.25 2.25 0 1 1 3 2.122v5.256a2.251 2.251 0 1 1-1.5 0V5.372A2.25 2.25 0 0 1 1.5 3.25Zm5.677-.177L9.573.677A.25.25 0 0 1 10 .854V2.5h1A2.5 2.5 0 0 1 13.5 5v5.628a2.251 2.251 0 1 1-1.5 0V5a1 1 0 0 0-1-1h-1v1.646a.25.25 0 0 1-.427.177L7.177 3.427a.25.25 0 0 1 0-.354ZM3.75 2.5a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Zm0 9.5a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Zm8.25.75a.75.75 0 1 0 1.5 0 .75.75 0 0 0-1.5 0Z"></path></svg>
                                            </span>
                                            <span className='hover:text-blue-700 cursor-pointer font-semibold max-w-full text-ellipsis max-h-12 text-wrap overflow-hidden' title={data.title}>
                                                <a href={data.pr_url.toString()} target="_blank" rel="noopener noreferrer">
                                                    {data.title}
                                                </a>
                                            </span>
                                        </div>
                                        <div className="px-2 py-1">
                                            ...
                                            <span className="underline hover:text-blue-700 cursor-pointer'">
                                                <a href={data.user_link.toString()} target="_blank" rel="noopener noreferrer">
                                                    {data.author}
                                                </a>
                                            </span>
                                            {" on "}
                                ...
                                <td>
                                    <div className='flex justify-center px-2 py-1 hover:cursor-pointer'>
                                        <div className="pt-1 pr-1">
                                            <svg role="img" style={{ fill: "black hover:text-blue-700" }} aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true">
